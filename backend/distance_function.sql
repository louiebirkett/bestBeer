...
CREATE OR REPLACE FUNCTION dist (posLat DECIMAL(35, 30), posLong DECIMAL(35, 30), userLat DECIMAL(35, 30), userLong DECIMAL(35, 30)) 
RETURNS DECIMAL(35, 30)
DETERMINISTIC
BEGIN
    DECLARE DIST_M DECIMAL(35, 30);
